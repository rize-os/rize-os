...
const menuBarItems = [
    { component: <MoreVert/>,
        ...
        theme: "icon tertiary",
        children: [
            { component: <><Edit style={{transform: "scale(0.8)"}}/><p className={"mx-2"}>Edit</p></> },
            { component: <><Delete style={{transform: "scale(0.8)"}}/><p className={"mx-2"}>Delete</p></>
            }
        ]
    }
]
    ...
    return (
        <div className={"border border-contrast-10 rounded-xl flex flex-col box-border " + className} style={style}>
            <section className={"flex flex-row gap-3.5 justify-center p-4 items-center"}>
                ...
                <div>
                    <MenuBar theme="icon" items={menuBarItems} onItemSelected={e => console.log(e)}/>
                </div>
            </section>
